...
class PathResolver:
    ...
    def amend_href(self, toc_dict):
        ...
        possible_target_readme = f"{os.path.splitext(resolvable_path)[0]}.md"
...
def filter_toc(toc_dict, namespaces, path_resolver):
    ...
    if "items" in toc_dict:
        ...
        for item in toc_dict['items']:
            if result_n := filter_toc(item, namespaces, path_resolver):
